...
%      applied to the GUI before page2_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 18-Mar-2008 23:06:19
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
M_im2 = aviread('im2.avi');
axes(handles.axes3);
imshow(M_im2(1).cdata);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
M_im3 = aviread('im3.avi');
axes(handles.axes4);
imshow(M_im3(1).cdata);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
M_im4 = aviread('im4.avi');
axes(handles.axes1);
imshow(M_im4(1).cdata);
