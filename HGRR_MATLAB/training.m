...
[M_im0 M_im1 M_im2] = read_avi_files1; % M_im3 M_im4 M_im5
% M_im2 M_im3 M_im4 M_im5
%   Loading Training and Testing set
N_train = length(M_im1);
data_train = create_data_struct2(M_im0,M_im1,M_im2);%,M_im3,M_im4,M_im5
...
net = newff( minmax(input_vectors_train),[nb_neurons 2], {'logsig' 'logsig'}, 'traingdx');% creating the NN
...
save('Neural_Network_1_21may','net','par_train');
